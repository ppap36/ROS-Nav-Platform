...
"""autogenerated by genpy from tracking_pid/FollowPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class FollowPathActionResult(genpy.Message):
  ...
  _type = "tracking_pid/FollowPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tracking_pid/FollowPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = tracking_pid.msg.FollowPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tracking_pid.msg.FollowPathResult()
